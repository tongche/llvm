...
bool ELFAsmParser::ParseDirectivePrevious(StringRef DirName, SMLoc) {
  ...
  if (PreviousSection == NULL) {
      // RecordStreamer always returns NULL as a section.
      // We check whether getStreamer() is RecordStreamer assuming
      // that all other streamers have non-null ObjectFileInfo
      // (FIXME: better way to check it).
      if (getStreamer().getContext().getObjectFileInfo() != NULL)
