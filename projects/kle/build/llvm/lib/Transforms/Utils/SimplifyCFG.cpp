...
static cl::opt<unsigned>
MaxPhiToFoldPerBB("max-phi-to-fold-per-bb", cl::Hidden, cl::init(2),
   cl::desc("The maximum number of phi nodes per basic block allowed for folding (default = 2)"));
...
STATISTIC(TwoEntryPhiNodesFolded, "Number of two-entry phi nodes transformed to select instruction");
