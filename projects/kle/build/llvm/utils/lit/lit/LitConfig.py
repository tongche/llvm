class LitConfig:
    ...
    def __init__(self, progname, path, quiet, showAllOutput,
                 useValgrind, valgrindLeakCheck, valgrindArgs,
                 useTclAsSh,
                 noExecute, ignoreStdErr, debug, isWindows,
                 params, excludeUnsupported):
        # The name of the test runner.
        self.progname = progname
        # The items to add to the PATH environment variable.
        self.path = list(map(str, path))
        self.quiet = bool(quiet)
        self.showAllOutput = bool(showAllOutput)
        ...
        self.excludeUnsupported = excludeUnsupported
        self.bashPath = None
