...
static StringSet<> CurrentDebugType;
...
bool llvm::isCurrentDebugType(const char *DebugType) {
  return CurrentDebugType.count(DebugType) || CurrentDebugType.empty();
}
