...
#include "../../VMCore/FunctionPassManagerImpl.h"
...
/// required by module pass MP. Instantiate analysis pass, by using
/// its runOnFunction() for function F.
Pass* CGPassManager::getOnTheFlyPass(Pass *MP, AnalysisID PI, Function &F){
